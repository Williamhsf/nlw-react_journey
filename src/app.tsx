        ...
        <div className='space-y-4'>
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            <div className='flex items-center gap-2 flex-1'>
              ...
              <input disabled={isGuestsInputOpen} type="text" placeholder="Para onde você vai?" className="bg-transparent text-lg outline-none flex-1 placeholder-zinc-400"/>
            </div>
          ...
          <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex gap-2 items-center'>
            ...
            <div className='px-2 flex items-center flex-1 gap-2'>
              ...
              <input 
                ...
                className="bg-transparent text-lg outline-none flex-1 placeholder-zinc-400"/>
            </div>
