import { MapPin, Calendar, Settings2, Plus, CircleCheck, Link2, UserCog, CircleDashed } from "lucide-react"
            ...
            <div className="space-y-2.5">
              ...
              <div className="space-y-2.5">
                <div className="px-4 py-2.5 bg-zinc-900 rounded-xl shadow-shape flex items-center gap-3">
                  ...
                  <span className="text-zinc-400 text-ms ml-auto">08:00h</span>
                </div>
